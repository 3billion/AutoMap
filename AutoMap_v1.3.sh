...
if [ "$multivcf" == "No" ]; then
    ...
    do
        ...
        echo "## AutoMap v1.3 used for analysis" >> $file;
    ...
    if [ "$numbervcf" -gt "1" ] && [ "$common" == "Yes" ] ; then
        ...
        if [ "$panelname" != "NA" ]; then
            ...
            echo "## AutoMap v1.3 used for analysis" >> $out/$output/$output.HomRegions.tsv;
            ...
            echo "## AutoMap v1.3 used for analysis" >> $out/$output/$output.HomRegions.$panelname.tsv;
